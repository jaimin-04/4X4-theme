(() => {
  ...
  // app/scripts/common/section/product-no-sidebar.js
  var ProductNoSbTemplate = {
    onLoad: function() {
      ...
      AT.initFormAddToCart(this.elms.formElm);
  ...
  // app/scripts/product-no-sb-page.js
  (() => {
    theme.sectionRegister.forEach((item) => {
      switch (item) {
        case "product-template":
          register(item, ProductNoSbTemplate);
          break;
    ...
    saveProductToCookie();
    console.log("product-no-sb-page.js loaded");
  })();
})();
